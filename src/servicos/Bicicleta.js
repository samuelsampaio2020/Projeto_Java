...
export default function Bicicleta(){
  ...
  function Create(){
    database.collection("agendaBicicleta").add({
      A_Codigo: identificador,
      B_Servico:toppings,
      C_ValorTotal:total,
      D_PrazoTotal:totalP,
  ...
  return (
      ...
      <View style={styles.container}>
        ...
        <div style={styles.formatoInicio}>
          ...
          <Text style={styles.textoInicio}>Bicicleta</Text>
        ...
        <div style={styles.formato}>
          ...
          <Text style={styles.texto}>Codigo Do Veiculo </Text>
          <TextInput 
            style={styles.campo}
            value={identificador}
